...
export default function SelectedWorks() {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: "Classic Snake reimagined using React. Includes an autonomous AI mode that plays until the grid is full.",
            year: "2026",
            tags: ["React", "Vite", "CSS3"],
            image: "https://github.com/mhudas/uwlar-snake-ai/blob/main/screenshots/screenshot.png?raw=true",
            link: "https://github.com/mhudas/uwlar-snake-ai",
            hideYear: true,
            disableZoom: true
        }
    ];
            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all group" href="#">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {currentProjects.map((project, index) => (
                                <div key={`${currentPage}-${index}`} className="group cursor-default">
                                    {project.type === 'embed' ? (
                ...
                <div className="flex justify-center items-center gap-4 mt-16">
                    <button
                        ...
                        className="text-white disabled:opacity-30 disabled:cursor-not-allowed hover:text-accent transition-colors"
                    >
                    ...
                    <div className="flex gap-2">
                        {[...Array(totalPages)].map((_, i) => (
                            <button
                                ...
                                className={`w-3 h-3 rounded-full transition-all duration-300 ${currentPage === i + 1 ? "bg-accent scale-125" : "bg-white/20 hover:bg-white/50"}`}
                            ></button>
                        ))}
                    </div>
                    <button
